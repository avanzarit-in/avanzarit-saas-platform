...
/**
 * The TransformerExceptionListener is invoked when an unexpected exception occurs
 * during transformation or while saving the transformed output.
 *
 * @param <I> The type of input entity that was being transformed.
 */
public interface TransformerExceptionListener<I> {
    /**
