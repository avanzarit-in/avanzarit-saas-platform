 ...
 */
public class DynamoDbTransformationTrigger<I, O> extends TransformationTrigger<I, O> {
    private static final Logger LOGGER = LogManager.getLogger(DynamoDbTransformationTrigger.class);

    public DynamoDbTransformationTrigger(Class<I> entityClass) {
        super(entityClass);
    }
