 ...
 */
public class S3TransformationTrigger<I, O> extends TransformationTrigger<I, O> {
    private static final Logger LOGGER = LogManager.getLogger(S3TransformationTrigger.class);

    public S3TransformationTrigger(Class<I> entityClass) {
        super(entityClass);
    }
